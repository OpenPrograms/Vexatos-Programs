...
{
  {
    ...
    r = "e76338b6-6d7a-44de-8bfb-5e2eb6b1dac8", -- addr of the RS IO block
  ...
  config = { --default config for Vanilla chests.
    inputSlots = {
      {{1, 4}, 6}, -- slot 1 to 4 are for matching inputs, slot 6 to 9 are for matching the required currency (both ranges have the same size).
      {{10, 13}, 15}, -- another range. Slot 10 to 13 are for matching inputs, slot 15 to 18 are for matching the required currency.
    },
